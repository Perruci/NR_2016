...
proc finish {} {
	...
	} out.tr > data/performance_TCP.data
	
	# Call xgraph plotting program to plot throughput vs time
	exec xgraph data/performance_TCP.data &
	...
	} out.tr > data/success_TCP.data


	# Call xgraph plotting program to plot throughput vs time
	exec xgraph data/drops_TCP.data data/success_TCP.data &   
	...
	} out.tr > data/jitter_TCP.data
	
	# Call xgraph plotting program to plot throughput vs time
	exec xgraph data/jitter_TCP.data  &
