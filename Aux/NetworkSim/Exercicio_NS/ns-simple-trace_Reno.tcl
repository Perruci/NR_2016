...
proc finish {} {
	...
	} out.tr > data/performance_Reno.data
	
	# Call xgraph plotting program to plot throughput vs time
	exec xgraph data/performance_Reno.data &
	...
	} out.tr > data/success_Reno.data


	# Call xgraph plotting program to plot throughput vs time
	exec xgraph data/drops_Reno.data data/success_Reno.data &   
	...
	} out.tr > data/jitter_Reno.data
	
	# Call xgraph plotting program to plot throughput vs time
	exec xgraph data/jitter_Reno.data  &
