...
proc finish {} {
	...
	} out.tr > data/performance_Vegas.data
	
	# Call xgraph plotting program to plot throughput vs time
	exec xgraph data/performance_Vegas.data &
	...
	} out.tr > data/drops_Vegas.data
	

	# Get data from trace file, put current-time and drops in a new file
	# Succesfully recived packages
	exec awk {
      	{
      	if ( (($1=="r") && ($3=="2") && ($4=="3") && ($5=="cbr")) || (($1=="r") && ($3=="2") && ($4=="3") && ($5=="tcp")) ) {
              old_data=old_data + 1
	...
	} out.tr > data/success_Vegas.data


	# Call xgraph plotting program to plot throughput vs time
	exec xgraph data/drops_Vegas.data data/success_Reno.data &   
	...
	} out.tr > data/jitter_Vegas.data
	
	# Call xgraph plotting program to plot throughput vs time
	exec xgraph data/jitter_Vegas.data  &
